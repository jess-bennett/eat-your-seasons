$(document).ready(function() {
  ...
  $(".month-select").click(function() {
    let selectedMonth = $(this).attr("id").substr(0, $(this).attr("id")
      .indexOf('-'));
  ...
  $(".quantity-icons").click(function() {
    let selectedQuantity = $(this).attr("id").substr(0, $(this).attr(
      "id").indexOf('-'));
  ...
  $(".interval-box").click(function() {
    ...
    let selectedInterval = $(this).attr("id").substr(0, $(this).attr(
      "id").indexOf('-'));
    $(".interval-type").hide();
...
function locationPlans() {
  ...
  window.location =
    `/plan/?month=${queryMonth}&week=${queryWeek}&quantity=${queryQuantity}`;
}
